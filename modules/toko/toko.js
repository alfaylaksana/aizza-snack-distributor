...
function bukaSettle(index){
    ...
    sumberItems.forEach(it=>{
        ...
        <div class="baris-settle" data-kode="${it.kode}" data-kirim="${it.jumlahKirim}" data-harga="${it.hargaToko}">
            ...
            <input class="returItem" type="number" placeholder="Retur" value="${it.jumlahRetur || 0}" oninput="hitungPreviewSettle()">
        </div>
        `;
    });

    document.getElementById("statusBayarSettle").value = t.statusBayar || "lunas";
    document.getElementById("jumlahDibayarSettle").value = t.jumlahDibayar || "";
