...
function kirimWA(index){
    ...
    if(t.status === "selesai"){
        ...
        teks += "Nota Pengambilan: " + (t.tanggalSettle || "") + "\n";
        teks += "(Titipan dikirim " + (t.tanggalKirim || "") + ")\n";
        teks += "Toko: " + (t.toko || "") + "\n\n";

        teks += "```\n";
        teks += rataKiri("Jml", 4) + rataKiri("Nama", 13) + rataKanan("Harga", 7) + rataKanan("Ret", 4) + "   " + rataKanan("Jumlah", 9) + "\n";
        teks += "-".repeat(40) + "\n";
        ...
        teks += "-".repeat(40) + "\n";
        teks += rataKiri("TOTAL", 28) + "   " + rataKanan(total.toLocaleString("id-ID"), 9) + "\n";
        teks += "```\n";
